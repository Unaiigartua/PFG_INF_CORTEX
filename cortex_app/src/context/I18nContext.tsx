...
const translations = {
  es: {
    ...
    'sql_result.yes': 'Sí',
    'sql_result.no': 'No',
    'sql_result.original_query': 'Consulta Original',
    'sql_result.edit': 'Editar',
    'sql_result.edit_query': 'Editar consulta',
    'sql_result.validated_terms': 'Términos Validados',
    'sql_result.generated_sql': 'Consulta SQL Generada',
    'sql_result.attempt': 'intento',
    'sql_result.attempts': 'intentos',
    'sql_result.auth_required': 'Token de autenticación requerido',
    'sql_result.validation_error': 'Error al validar la consulta SQL',
    'sql_result.score': 'puntuación',
    'sql_result.example_question': 'Pregunta',

    // Query History
    'query_details.title': 'Detalles de la consulta',
    'query_details.original_question': 'Pregunta original',
    'query_details.validated_medical_terms': 'Términos médicos validados',
    'query_details.generated_sql': 'SQL generado',
    'query_details.status': 'Estado',
    'query_details.executable': 'Ejecutable',
    'query_details.not_executable': 'No ejecutable',
    'query_details.attempts': 'Intentos',
    'query_details.processing_time': 'Tiempo de procesamiento',
    'query_details.results_count': 'Número de resultados',
    'query_details.error': 'Error',
    'query_details.additional_info': 'Información adicional',
    'query_details.query_id': 'ID de consulta',
    'query_details.timestamp': 'Fecha y hora',
    'query_details.title_title': 'Título',
  ...
  en: {
    ...
    'sql_result.yes': 'Yes',
    'sql_result.no': 'No',
    'sql_result.original_query': 'Original Query',
    'sql_result.edit': 'Edit',
    'sql_result.edit_query': 'Edit query',
    'sql_result.validated_terms': 'Validated Terms',
    'sql_result.generated_sql': 'Generated SQL Query',
    'sql_result.attempt': 'attempt',
    'sql_result.attempts': 'attempts',
    'sql_result.auth_required': 'Authentication token required',
    'sql_result.validation_error': 'Error validating SQL query',
    'sql_result.score': 'score',
    'sql_result.example_question': 'Question',

    // Query History
    'query_details.title': 'Query Details',
    'query_details.original_question': 'Original question',
    'query_details.validated_medical_terms': 'Validated medical terms',
    'query_details.generated_sql': 'Generated SQL',
    'query_details.status': 'Status',
    'query_details.executable': 'Executable',
    'query_details.not_executable': 'Not executable',
    'query_details.attempts': 'Attempts',
    'query_details.processing_time': 'Processing time',
    'query_details.results_count': 'Results count',
    'query_details.error': 'Error',
    'query_details.additional_info': 'Additional information',
    'query_details.query_id': 'Query ID',
    'query_details.timestamp': 'Date and time',
    'query_details.title_title': 'Title',
  }
} as const;
